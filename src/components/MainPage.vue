    ...
    questions: [
      {
        id: 66,
        score: 1000,
        text: 'В XVII столетии эта страна имела собственные колонии в Карибском море и в Африке – крошечный островок Сент-Эндрюс в устье реки Гамбия (ныне остров Джейс) и остров Тобаго, который теперь входит в состав государства Тринидад и Тобаго.'
      },
      {
        id: 67,
        score: 700,
        text: 'Флаг этой страны – один из старейших в мире. Впервые флаг в его современном виде был использован в 1280 году. Старше его – только датский флаг.'
      },
      {
        id: 68,
        score: 500,
        text: 'На каждого жителя страны приходятся 2 студента — это один из самых высоких показателей в мире.'
      },
      {
        id: 69,
        score: 300,
        text: '54% территории страны покрыто лесами, 10% – болотами.'
      },
      {
        id: 70,
        score: 100,
        text: 'Один из главных сувениров – черный бальзам – появился в середине XVIII века. Его на основании старинного рецепта водочного настоя целебных трав создал аптекарь Абрахам Кунце.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: 71,
        score: 1000,
        text: 'Этнос страны - результат смешения скифов, сарматов, семитов с арийцами, насчитывает сотни лет, но его родословная корнями уходит вглубь тысячелетий, к легендарным ираноязычным народам.'
      },
      {
        id: 72,
        score: 700,
        text: 'Столица республики — старинный город, знаменитый своими древними памятниками архитектуры, называют городом 37 храмов. В переводе название столицы означает "место обитания высшей касты жрецов".'
      },
      {
        id: 73,
        score: 500,
        text: 'Большая часть республики (почти 90%) расположена на высоте более 1000 метров над уровнем моря, и это зона сейсмической активности. Вершина Халаца – самая высокая — 3938 метров.'
      },
      {
        id: 74,
        score: 300,
        text: 'В стране находится озеро-призрак Ерцо, одно из самых уникальных и мистических озер на планете. Каждые 5 лет вода просто уходит, а спустя несколько недель возвращается обратно. Так происходит несколько тысяч лет. Вода здесь чистейшая, а живности нет. До сих пор не выяснено, куда же все-таки эта вода девается.'
      },
      {
        id: 75,
        score: 100,
        text: 'Россия официально признала независимость республики в конце августа 2008 года, вместе с ней это сделала и страна Никарагуа. Позже независимость республики, признали Венесуэла, Науру, Сирия, Тувалу.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: 76,
        score: 1000,
        text: 'Когда-то Великое княжество собирало под своим правлением земли от Балтийского моря до Черного, включая Крым и просуществовало с середины XIII века по 1795.'
      },
      {
        id: 77,
        score: 700,
        text: 'Язык этой страны – один из древнейших языков мира, а также один из старейших живых индоевропейских языков, он сохранил множество древних особенностей и считается самым ближайшим языком к санскриту. Благодаря этой особенности его изучают во многих университетах мира.'
      },
      {
        id: 78,
        score: 500,
        text: 'На территории государства имеется лишь 106 городов, и среди них нет ни одного города-миллионника.'
      },
      {
        id: 79,
        score: 300,
        text: 'Национальный символ – белый аист. На Токийской конференции в 1960 году страна взяла на себя обязательства по сохранению и увеличению численности этого вида птиц.'
      },
      {
        id: 80,
        score: 100,
        text: 'Национальный вид спорта – баскетбол. Он приобрёл популярность с 30-х годов прошлого века и по сей день не сдаёт своих позиций.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: 81,
        score: 1000,
        text: 'Столица этой страны почти в 3 раза старше, чем Москва: этому прекрасному городу… уже больше 2 500 лет!'
      },
      {
        id: 82,
        score: 700,
        text: 'Страна мировой лидер по обеспеченности пресной водой на душу населения.'
      },
      {
        id: 83,
        score: 500,
        text: 'В стране находится самый маленький город в мире, имеющий собственное метро.'
      },
      {
        id: 84,
        score: 300,
        text: 'На территории страны расположены 5 дач Сталина.'
      },
      {
        id: 85,
        score: 100,
        text: 'Жители называют свою республику «Апсны», что означает «Страна души».'
      }
    ]
  }
]
...
const mapActions = ref({
  US: {
    ...
    info: {
      ...
      capital: 'Вашингтон',
      flag: 'usa',
      desc: '4 апреля 1949 года главы  МИД  12 государств  подписали в Вашингтоне Североатлантический договор , ставший основой военно-политического союза - Организации Североатлантического договора (НАТО). Его цель-  защита Европы от возможной угрозы советской экспансии. Штаб-квартира НАТО — политический и административный центр Североатлантического альянса - Брюссель(Бельгия).'
    }
  },
  CN: {
    class: {
  ...
  EE: {
    ...
    info: {
      ...
      capital: 'Таллин',
      flag: 'estonia',
      desc: 'Эстония присоединилась к НАТО 2 апреля 2004 года, в рамках самого крупного за всю историю этого альянса «пятого расширения». Эстония принимала и принимает активное участие в операциях НАТО: Косово, Ираке и Афганистане. Военные подразделения и корабли Эстонии входят в состав «Сил реагирования НАТО»'
    }
  },
  MN: {
    class: {
  ...
  NO: {
    ...
    info: {
      ...
      capital: 'Осло',
      flag: 'norway',
      desc: 'Норвегия является членом НАТО с момента зарождения этого альянса, с 1949 года.'
    }
  },
  KZ: {
    class: {
    ...
    info: {
      ...
      capital: 'Астана',
      flag: 'kazakhstan',
      desc: 'Дата ратификации Соглашения о создании ДКБ 15 мая 1992.'
    }
  },
  FI: {
    class: {
    ...
    info: {
      ...
      capital: 'Хельсинки',
      flag: 'finland',
      desc: 'Финляндия. Вступила  в НАТО  4 апреля 2023 года, отказавшись от нейтралитета, которого придерживалась 75 лет, став 31 членом НАТО.'
    }
  },
  KP: {
    class: {
  ...
  BY: {
    ...
    info: {
      ...
      capital: 'Минск',
      flag: 'belarus',
      desc: 'Дата ратификации Соглашения о создании ДКБ 31 декабря 1993.'
    }
  },
  GE: {
    class: {
  ...
  PL: {
    ...
    info: {
      ...
      capital: '	Варшава',
      flag: 'poland',
      desc: 'Польша вступила в НАТО 12 марта 1999 года. На территории страны систематически проводятся учения альянса по отработке применения, как сухопутных сил, так и ВВС и ВМС.'
    }
  },
  LV: {
    class: {
    ...
    info: {
      ...
      capital: 'Рига',
      flag: 'latvia',
      desc: 'Латвия вошла в состав НАТО 29 марта 2004 года.  С 2006 года латвийские солдаты входят в состав Сил реагирования НАТО.'
    }
  },
  SU: {
    class: {
  ...
  LT: {
    ...
    info: {
      ...
      capital: 'Вильнюс',
      flag: 'lithuania',
      desc: 'Литва 26 марта 2003 государства — члены НАТО подписали в Брюсселе  договор о присоединении Литвы  Североатлантическому договору. Являясь членом НАТО, Литва проводит работу по модернизации своих вооруженных сил в соответствии со стандартами альянса.'
    }
  },
  ABK: {
    class: {
